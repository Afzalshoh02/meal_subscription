...
@section('content')
    ...
    <h1 class="text-center text-secondary fw-bold mb-4">➕ Create New Tariff</h1>
    ...
    <div class="w-50 mx-auto shadow-lg p-4 rounded bg-light">
        <form action="{{ route('tariffs.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="ration_name" id="ration_name" class="form-control" required value="{{ old('ration_name') }}">
                @error('ration_name')
            ...
            <div class="mb-3">
                ...
                <select name="cooking_day_before" id="cooking_day_before" class="form-select" required>
                    <option value="1" {{ old('cooking_day_before') == "1" ? 'selected' : '' }}>✅ Yes</option>
                    <option value="0" {{ old('cooking_day_before') == "0" ? 'selected' : '' }}>❌ No</option>
                </select>
